...
public class BankServiceLocator extends org.apache.axis.client.Service implements fr.uge.webServices.project.BankService {
    ...
    private java.lang.String Bank_address = "http://localhost:8080/BanqueService/services/Bank";
    ...
    public fr.uge.webServices.project.Bank getBank(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.uge.webServices.project.BankSoapBindingStub _stub = new fr.uge.webServices.project.BankSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.uge.webServices.project.Bank.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.uge.webServices.project.BankSoapBindingStub _stub = new fr.uge.webServices.project.BankSoapBindingStub(new java.net.URL(Bank_address), this);
                _stub.setPortName(getBankWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://project.webServices.uge.fr", "BankService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://project.webServices.uge.fr", "Bank"));
        }
